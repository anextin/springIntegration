...
public class AgreementSpecification {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, description, isBundle, lastUpdate, lifecycleStatus, name, version, attachment, relatedParty, serviceCategory, specificationCharacteristic, specificationRelationship, validFor, baseType, schemaLocation, type);
  }
