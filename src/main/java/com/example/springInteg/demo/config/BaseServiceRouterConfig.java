...
public class BaseServiceRouterConfig {
    ...
    /**
     * A transformer that converts string containing JSON to an {@link com.example.springInteg.demo.model.eai.ProductOrderCreate} object.
     * <p>
    ...
    public JsonToObjectTransformer jsonToObjectTransformer() {
        return new JsonToObjectTransformer(ProductOrderCreate.class);
    }
